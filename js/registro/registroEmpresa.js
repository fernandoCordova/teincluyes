$("#btnRegistro").click(function (e) {
  if (
    ...
    validarNombreEmpresa() == true &&
    validarTelefono() == true &&
    validarRut() == true
  ) {
    $("#formRegistroEmpresa").submit();
  } else {
    e.preventDefault();
  }
});
...
function validarNombreEmpresa() {
  if ($("#nombreEmpresa").val() != "") {
    ...
    $("#nombreEmpresa").css("border-width", "2px");
    $("#errorNombreEmpresa").html(
      "<span class='text-success'>Nombre de empresa valido</span>"
    );
    return true;
  } else {
    ...
    $("#nombreEmpresa").css("border-width", "2px");
    $("#errorNombreEmpresa").html(
      "<span class='text-danger'>Nombre de empresa no valido</span>"
    );
    return false;
  }
}
...
function validarTelefono() {
  if ($("#telefono").val() != "") {
    ...
    $("#telefono").css("border-width", "2px");
    $("#errorTelefono").html(
      "<span class='text-success'>Telefono valido</span>"
    );
    return true;
  } else {
    ...
    $("#telefono").css("border-width", "2px");
    $("#errorTelefono").html(
      "<span class='text-danger'>Telefono no valido</span>"
    );
    return false;
  }
}
